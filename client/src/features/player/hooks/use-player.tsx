...
//
// Make player available globally with Context API
//
...
const initialt = {} as Context;

const PlayerContext = React.createContext<Context>(initialt);
...
function PlayerConsumer(): Context {
  return React.useContext(PlayerContext);
}

export { PlayerProvider, PlayerConsumer as usePlayer };
